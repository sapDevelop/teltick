...
\end{figure}
 ...
 Das Objektdiagramm zeigt teile des modellierten Systems.
...
\hline \hline
 ...
 \hline
  Haupt-Anwender: & Mitarbeiter  \\
   \hline
  Auslöser: & Button: \glqq Neues Ticket anlegen\grqq \\
   \hline
  ...
  Nachbedingungen: & Ticket erfolgreich angelegt \\
   \hline
  Normalablauf:
 & 1. [AKTEUR]: Klick auf Button \glqq Neues Ticket anlegen\grqq  \\
