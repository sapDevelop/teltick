		...
		<div class="admin_benutzeruebersicht_content_aufteiler">
			<div class="admin_benutzeruebersicht_content_bereich_benutzerauflistung" >
				...
				<div id="admin_benutzeruebersicht_liste" >
					...
					<div id="admin_benutzeruebersicht_liste_tabelle">
						...
						<input type="radio" name="benutzer_radio" class="benutzer_radio" id="benutzer_radio_1" value="1" />
						<label class="div_tabelle_zeile" for="benutzer_radio_1" onclick="button_enable();" >
			...
			<div class="admin_benutzeruebersicht_content_bereich_buttons" >
				<div class="admin_benutzeruebersicht_platzierung" >
					...
					<input type="submit" value="Benutzer ändern" name="button_benutzerverwaltung"  class="button_benutzerverwaltung" title="Markierten Benutzer ändern" disabled="disabled"  id="button_benutzerverwaltung_aendern"  />
					<input type="submit" value="Benutzer löschen" name="button_benutzerverwaltung"  class="button_benutzerverwaltung" title="Markierten Benutzer löschen" disabled="disabled" id="button_benutzerverwaltung_loeschen" />
				</div>
			</div>
		</div>
